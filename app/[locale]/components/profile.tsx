  ...
  return (
    <div className="flex flex-col space-y-3 justify-center items-center md:items-start w-full">
      ...
      <div className="flex space-x-3">
        ...
        <Link href={"https://x.com/solclarus"} target="_blank">
          <svg
            role="img"
            viewBox="0 0 24 24"
        ...
        <Link href={"https://github.com/solclarus"} target="_blank">
          <svg
            role="img"
            viewBox="0 0 24 24"
            xmlns="http://www.w3.org/2000/svg"
        ...
        <Link href={"https://www.instagram.com/sol.clarus"} target="_blank">
          <svg
            role="img"
            viewBox="0 0 24 24"
            xmlns="http://www.w3.org/2000/svg"
